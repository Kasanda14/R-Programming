...
rownames(FT) <- c("KobeBryant","JoeJohnson","LeBronJames",
                  "CarmeloAnthony","DwightHoward","ChrisBosh"
                  ,"ChrisPaul","KevinDurant","DerrickRose",
                  "DwayneWade")

colnames(FT) <- c("2005","2006","2007","2008","2009","2010",
                  "2011","2012","2013","2014")

FT

#CREATING MATIRX FTA 
FTA <- rbind(rbind(KobeBryant_FTA,JoeJohnson_FTA,LeBronJames_FTA,
                   CarmeloAnthony_FTA,DwightHoward_FTA,ChrisBosh_FTA
                   ,ChrisPaul_FTA,KevinDurant_FTA,DerrickRose_FTA,
                   DwayneWade_FTA))

rownames(FTA) <- c("KobeBryant","JoeJohnson","LeBronJames",
                  "CarmeloAnthony","DwightHoward","ChrisBosh"
                  ,"ChrisPaul","KevinDurant","DerrickRose",
                  "DwayneWade")
colnames(FTA) <- c("2005","2006","2007","2008","2009","2010",
                  "2011","2012","2013","2014")
...
#PLAYER STYLE PATTERNS EXCLUDIND FREETHROWS
myplot((FieldGoals - FT)/Games)
